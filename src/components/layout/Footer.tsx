    ...
    <footer className="w-full mt-20">
      ...
      <div className="bg-[#60523f] text-white py-24 px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <button className="bg-white text-[#60523f] px-8 py-3.5 rounded-full font-bold text-sm hover:bg-gray-100 transition-colors">
            Book Your Consultation
          </button>
          <button className="bg-transparent border border-white/30 text-white px-8 py-3.5 rounded-full font-bold text-sm hover:bg-white/10 transition-colors">
            Download Guide
          </button>
        </div>
      </div>
      ...
      <div className="bg-[#d4c5b0] text-[#60523f] py-16 px-6 text-center pb-32 md:pb-16">
        ...
        <div className="flex flex-wrap justify-center gap-6 text-[10px] uppercase tracking-[0.15em] font-bold mb-8 opacity-80">
          ...
          <Link to="#" className="hover:opacity-100 transition-opacity">FAQ</Link>
          <a href="https://instagram.com/lifecoachomkar" target="_blank" rel="noopener noreferrer" className="hover:opacity-100 transition-opacity">Instagram</a>
          <a href="https://www.linkedin.com/in/coach-omkarpawar/" target="_blank" rel="noopener noreferrer" className="hover:opacity-100 transition-opacity">LinkedIn</a>
        </div>
